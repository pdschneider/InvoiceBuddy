# Utils/version_gen.py
# Auto-generates version.txt from version.py for PyInstaller Windows builds
# Run this before building, or call it automatically from your .spec file.
    ...
    StringFileInfo(
      ...
      StringTable(
        ...
        [
          ...
          StringStruct('LegalCopyright', 'Copyright © 2026 {__author__}. All rights reserved.'),
