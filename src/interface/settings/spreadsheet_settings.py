...
def create_spreadsheet_settings_tab(globals, spreadsheet_tab):
    ...
    # Invoice Paths Frame
    invoice_paths_section = ctk.CTkFrame(
    ...
    slider_frame_1 = ctk.CTkFrame(
        invoice_paths_section, fg_color="transparent")
    ...
    ctk.CTkLabel(invoice_paths_section,
                 font=fonts.heading_font,
                 text="First Column:"
                 ).grid(row=3, column=0, padx=(20, 10), sticky="w")

    slider_frame_2 = ctk.CTkFrame(
        invoice_paths_section, fg_color="transparent")
    ...
    ctk.CTkLabel(invoice_paths_section,
                 font=fonts.heading_font,
                 text="Column Order:"
                 ).grid(row=4, column=0, padx=(20, 10), sticky="w")

    # Invoice Components
    invoice_components_frame = ctk.CTkFrame(
        invoice_paths_section, fg_color="transparent")
    ...
    ctk.CTkLabel(invoice_paths_section,
                 font=fonts.heading_font,
                 text="Select Icon:"
                 ).grid(row=6, column=0, padx=(20, 10), sticky="w")

    # Invoice image selection sub-frame
    invoice_icons_frame = ctk.CTkFrame(
        invoice_paths_section, fg_color="transparent")
    ...
    # Card Components
    card_components_frame = ctk.CTkFrame(
    ...
    po_components_frame = ctk.CTkFrame(
        po_paths_section, fg_color="transparent")
