...
Invoice Buddy automatically detects vendors by scanning invoice text and matches them against known company names.  
This document lists every currently supported company with its **full official/legal name**.

## Pest Control & Cleaning Services

- Aahrats Pest Control, LLC
- Aardvark Services Inc.
- Advanced Asbestos Co.
- Batmaster
- Roto-Rooter
- Seaside Services
